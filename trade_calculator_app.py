    ...
    try:
        ...
        if not df.empty:
            ...
            if selected_player:
                ...
                st.markdown(f"<ul style='text-align:center; list-style-position: inside;'><li><strong>QB Premium:</strong> +{qb_premium if qb_premium else 0}</li>", unsafe_allow_html=True)
